...
public class TestCase {
	...
	public void processTests(){
	    ...
	    String processId1 = runtimeService.startProcessInstanceByKey("Interview").getId();
	    String processId2 = runtimeService.startProcessInstanceByKey("Interview").getId();
	    System.out.println("processId="+processId);
	    System.out.println("processId1="+processId1);
	    System.out.println("processId2="+processId2);
