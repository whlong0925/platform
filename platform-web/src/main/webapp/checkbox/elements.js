...
var Custom = {
	init: function() {
		...
		for(i = 0; i < inputs.length; i++) {
			if((inputs[i].type == "checkbox" || inputs[i].type == "radio") && inputs[i].className == "styled") {
